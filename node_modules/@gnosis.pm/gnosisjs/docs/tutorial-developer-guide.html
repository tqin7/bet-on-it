...
<head>
    ...
    <title>Developer Guide - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">Developer Guide</h1>
...
<header>
    ...
    <ul>
        ...
        <li><a href="tutorial-api-overview.html">API Overview</a></li>
    
        <li><a href="tutorial-events-oracles-and-markets.html">Events, Oracles, and Markets</a></li>
    
        <li><a href="tutorial-lmsr-primer.html">LMSR Primer</a></li>
    </ul>
    
</header>

<article>
    <p>In order to follow this guide, you will need to be comfortable working in your OS's shell, writing JavaScript, and working with <a href="https://www.npmjs.com/">npm</a>. A working knowledge of <a href="https://www.ethereum.org/">Ethereum</a>, <a href="https://github.com/ethereum/solidity">Solidity</a>, and <a href="http://truffleframework.com/">Truffle</a> would greatly ease the use of this library, but is not strictly necessary for getting started. The usage of a VCS such as <a href="https://git-scm.com/">Git</a> is also encouraged, but is not explained here.</p>
</article>
