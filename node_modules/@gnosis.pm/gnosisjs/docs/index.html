...
<div id="main">
    ...
    <section class="readme">
        <article><h1>Gnosis.js Library</h1><p><a href="https://gnosis.pm/"><img src="https://raw.githubusercontent.com/gnosis/gnosis.js/master/assets/logo.png" alt="Logo"></a></p>
<p><a href="https://travis-ci.org/gnosis/gnosis.js"><img src="https://travis-ci.org/gnosis/gnosis.js.svg?branch=master" alt="Build Status"></a></p>
<p><a href="https://slack.gnosis.pm"><img src="https://slack.gnosis.pm/badge.svg" alt="Slack Status"></a></p>
<h2>Really quick start</h2><ol>
<li>Get <a href="https://github.com/ethereumjs/testrpc">TestRPC</a></li>
<li>Run this:<pre class="prettyprint source"><code>testrpc -d -i 437894314312</code></pre></li>
<li>Clone <a href="https://github.com/gnosis/gnosis-contracts">Gnosis contracts</a>, cd in there, and migrate the contracts onto the TestRPC instance with:<pre class="prettyprint source"><code>cd path/to/gnosis-contracts
npm install
npm run migrate</code></pre></li>
<li>Download <a href="https://raw.githubusercontent.com/gnosis/gnosis.js/master/dist/gnosis.js"><code>gnosis.js</code></a> and put it in an HTML file:<pre class="prettyprint source"><code>&lt;script src=gnosis.js>&lt;/script></code></pre></li>
<li>Follow some tutorials:<ul>
<li><a href="https://gnosis.github.io/gnosis.js/tutorial-api-overview.html">API Overview</a></li>
<li><a href="https://gnosis.github.io/gnosis.js/tutorial-events-oracles-and-markets.html">Events, Oracles, and Markets</a></li>
</ul>
</li>
</ol>
<h2>Installation</h2><p>Run <code>npm install</code> to install dependencies.</p>
<p>Needs a Web3 provider to work. For testing, try TestRPC.</p>
<h2>Development</h2><p>Before you begin, you will want to have the contracts deployed on the chain you plan to use. You can deploy contracts through the RPC interface on localhost:8545 with</p>
...
<h3>Running the tests</h3><p>Run <code>npm test</code> to run test suite. This should run without the need of an RPC provider running on localhost:8545. If you already have such a provider running and wish to run the test suite without automatically spinning up TestRPC and causing a chain migration, use <code>npm run test-manual</code>.</p>
...
<pre class="prettyprint source lang-javascript"><code>// using the estimateGas RPC
